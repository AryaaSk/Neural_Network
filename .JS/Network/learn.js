...
const Learn1 = (network, stepSize, dataset) => {
...
const UpdateWeightsBiases = (nodeValue, currentNeuron, currentlayer, previousLayer, weightDescentGradients, biasDescentGradients) => {
    for (const prevNeuron of previousLayer.neurons) {
        ...
        weightDescentGradients[weightKey] += weightGradient;
    }
    //d[NC]/d[Bias] = 1 * (1 - Sigmoid(RO))Sigmoid(RO) * 2([ExpectedOutput] - [O])
...
const ApplyGradients = (stepSize, weightDescentGradients, biasDescentGradients) => {
