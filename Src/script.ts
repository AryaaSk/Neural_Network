...
const AdjustWeights = (layers: Layer[], correctIndex: number) => {
    const adjustSpecificWeight = (layer1ID: string, layer2ID: string, neuron1ID: string, neuron2ID: string, loss: number) => {
